...
Item {
    ...
    Image {
        id: chirismusIcon_l
        width: 64; height: 40;
        anchors{left:chirismusON_l.right; leftMargin: 24; top:chirismusON_l.top; topMargin: 12;}
        source: "qrc:/images/chair/Set_icon_hcl.png";
    }

    Image {
        id: chirismusIcon_r
        width: 64; height: 40;
        anchors{left:chirismusON_r.right; leftMargin: 24; top:chirismusON_r.top; topMargin: 12;}
        source: "qrc:/images/chair/Set_icon_hcl.png";
    }
